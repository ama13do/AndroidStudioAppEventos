...
export 'aniversario_model.dart';

class AniversarioWidget extends StatefulWidget {
  const AniversarioWidget({
    super.key,
    this.title,
    this.duration,
    String? mail,
  ...
  @override
  State<AniversarioWidget> createState() => _AniversarioWidgetState();
}

class _AniversarioWidgetState extends State<AniversarioWidget> {
  late AniversarioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AniversarioModel());
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'agw06ti3' /* Nombre del aniversario */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                            ...
                            Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'xm1g5hq3' /* Descripcion del aniversario */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
