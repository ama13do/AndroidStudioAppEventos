...
import 'cuentaregresiva_model.dart';
export 'cuentaregresiva_model.dart';

class CuentaregresivaWidget extends StatefulWidget {
  const CuentaregresivaWidget({
    super.key,
    this.title,
    this.duration,
    String? mail,
  ...
  @override
  State<CuentaregresivaWidget> createState() => _CuentaregresivaWidgetState();
}

class _CuentaregresivaWidgetState extends State<CuentaregresivaWidget> {
  late CuentaregresivaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CuentaregresivaModel());
                            ...
                            Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'zxxcz4y0' /* Descripcion del evento */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
